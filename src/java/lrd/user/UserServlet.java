...
import static lrd.user.JSONResponses.DENY_ACCESS;
import static lrd.user.JSONResponses.INCORRECT_REQUEST;
import static lrd.user.JSONResponses.POST_REQUIRED;

public final class UserServlet extends HttpServlet  {

    abstract static class UserRequestHandler {
        abstract JSONStreamAware processRequest(HttpServletRequest request, User user) throws LrdException, IOException;
        boolean requirePost() {
            return false;
        }
    }

    private static final boolean enforcePost = Lrd.getBooleanProperty("lrd.uiServerEnforcePOST");
    ...
    private void process(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        } catch (RuntimeException|LrdException e) {
