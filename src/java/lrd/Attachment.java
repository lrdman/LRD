...
public interface Attachment extends Appendix {
    ...
    abstract class AbstractAttachment extends Appendix.AbstractAppendix implements Attachment {
        ...
        @Override
        final void validate(Transaction transaction) throws LrdException.ValidationException {
            getTransactionType().validateAttachment(transaction);
        }

        @Override
        final void validateAtFinish(Transaction transaction) throws LrdException.ValidationException {
    ...
    final class MessagingAliasAssignment extends AbstractAttachment {
        ...
        MessagingAliasAssignment(ByteBuffer buffer, byte transactionVersion) throws LrdException.NotValidException {
            super(buffer, transactionVersion);
    ...
    final class MessagingAliasSell extends AbstractAttachment {
        ...
        MessagingAliasSell(ByteBuffer buffer, byte transactionVersion) throws LrdException.NotValidException {
            super(buffer, transactionVersion);
            this.aliasName = Convert.readString(buffer, buffer.get(), Constants.MAX_ALIAS_LENGTH);
            this.priceLQT = buffer.getLong();
        }

        MessagingAliasSell(JSONObject attachmentData) {
            super(attachmentData);
            this.aliasName = Convert.nullToEmpty((String) attachmentData.get("alias"));
            this.priceLQT = Convert.parseLong(attachmentData.get("priceLQT"));
        }

        public MessagingAliasSell(String aliasName, long priceLQT) {
            this.aliasName = aliasName;
            this.priceLQT = priceLQT;
        }
        ...
        void putMyBytes(ByteBuffer buffer) {
            ...
            buffer.putLong(priceLQT);
        }

        @Override
        void putMyJSON(JSONObject attachment) {
            attachment.put("alias", aliasName);
            attachment.put("priceLQT", priceLQT);
        }
    ...
    final class MessagingAliasBuy extends AbstractAttachment {
        ...
        MessagingAliasBuy(ByteBuffer buffer, byte transactionVersion) throws LrdException.NotValidException {
            super(buffer, transactionVersion);
            this.aliasName = Convert.readString(buffer, buffer.get(), Constants.MAX_ALIAS_LENGTH);
        }
    ...
    final class MessagingAliasDelete extends AbstractAttachment {
        ...
        MessagingAliasDelete(final ByteBuffer buffer, final byte transactionVersion) throws LrdException.NotValidException {
            super(buffer, transactionVersion);
            this.aliasName = Convert.readString(buffer, buffer.get(), Constants.MAX_ALIAS_LENGTH);
        }
    ...
    final class MessagingPollCreation extends AbstractAttachment {
        ...
        MessagingPollCreation(ByteBuffer buffer, byte transactionVersion) throws LrdException.NotValidException {
            super(buffer, transactionVersion);
            ...
            if (numberOfOptions > Constants.MAX_POLL_OPTION_COUNT) {
                throw new LrdException.NotValidException("Invalid number of poll options: " + numberOfOptions);
            }
    ...
    final class MessagingVoteCasting extends AbstractAttachment {
        ...
        public MessagingVoteCasting(ByteBuffer buffer, byte transactionVersion) throws LrdException.NotValidException {
            super(buffer, transactionVersion);
            pollId = buffer.getLong();
            int numberOfOptions = buffer.get();
            if (numberOfOptions > Constants.MAX_POLL_OPTION_COUNT) {
                throw new LrdException.NotValidException("More than " + Constants.MAX_POLL_OPTION_COUNT + " options in a vote");
            }
    ...
    final class MessagingPhasingVoteCasting extends AbstractAttachment {
        ...
        MessagingPhasingVoteCasting(ByteBuffer buffer, byte transactionVersion) throws LrdException.NotValidException {
            super(buffer, transactionVersion);
            ...
            if (secretLength > Constants.MAX_PHASING_REVEALED_SECRET_LENGTH) {
                throw new LrdException.NotValidException("Invalid revealed secret length " + secretLength);
            }
            if (secretLength > 0) {
    ...
    final class MessagingHubAnnouncement extends AbstractAttachment {
        ...
        private final long minFeePerByteLQT;
        private final String[] uris;

        MessagingHubAnnouncement(ByteBuffer buffer, byte transactionVersion) throws LrdException.NotValidException {
            super(buffer, transactionVersion);
            this.minFeePerByteLQT = buffer.getLong();
            int numberOfUris = buffer.get();
            if (numberOfUris > Constants.MAX_HUB_ANNOUNCEMENT_URIS) {
                throw new LrdException.NotValidException("Invalid number of URIs: " + numberOfUris);
            }
        ...
        MessagingHubAnnouncement(JSONObject attachmentData) throws LrdException.NotValidException {
            super(attachmentData);
            this.minFeePerByteLQT = (Long) attachmentData.get("minFeePerByte");
            try {
                ...
                throw new LrdException.NotValidException("Error parsing hub terminal announcement parameters", e);
            }
        }

        public MessagingHubAnnouncement(long minFeePerByteLQT, String[] uris) {
            this.minFeePerByteLQT = minFeePerByteLQT;
            this.uris = uris;
        }
        ...
        @Override
        void putMyBytes(ByteBuffer buffer) {
            buffer.putLong(minFeePerByteLQT);
        ...
        @Override
        void putMyJSON(JSONObject attachment) {
            attachment.put("minFeePerByteLQT", minFeePerByteLQT);
        ...
        public long getMinFeePerByteLQT() {
            return minFeePerByteLQT;
        }
    ...
    final class MessagingAccountInfo extends AbstractAttachment {
        ...
        MessagingAccountInfo(ByteBuffer buffer, byte transactionVersion) throws LrdException.NotValidException {
            super(buffer, transactionVersion);
    ...
    final class ColoredCoinsAssetIssuance extends AbstractAttachment {
        ...
        ColoredCoinsAssetIssuance(ByteBuffer buffer, byte transactionVersion) throws LrdException.NotValidException {
            super(buffer, transactionVersion);
    ...
    final class ColoredCoinsAssetTransfer extends AbstractAttachment {
        ...
        ColoredCoinsAssetTransfer(ByteBuffer buffer, byte transactionVersion) throws LrdException.NotValidException {
            super(buffer, transactionVersion);
    ...
    abstract class ColoredCoinsOrderPlacement extends AbstractAttachment {
        ...
        private ColoredCoinsOrderPlacement(long assetId, long quantityQNT, long priceLQT) {
            this.assetId = assetId;
            this.quantityQNT = quantityQNT;
            this.priceLQT = priceLQT;
        }
    ...
    final class ColoredCoinsAskOrderPlacement extends ColoredCoinsOrderPlacement {
        ...
        public ColoredCoinsAskOrderPlacement(long assetId, long quantityQNT, long priceLQT) {
            super(assetId, quantityQNT, priceLQT);
        }
    ...
    final class ColoredCoinsBidOrderPlacement extends ColoredCoinsOrderPlacement {
        ...
        public ColoredCoinsBidOrderPlacement(long assetId, long quantityQNT, long priceLQT) {
            super(assetId, quantityQNT, priceLQT);
        }
    ...
    final class ColoredCoinsDividendPayment extends AbstractAttachment {
        ...
        ColoredCoinsDividendPayment(JSONObject attachmentData) {
            ...
            this.amountLQTPerQNT = Convert.parseLong(attachmentData.get("amountLQTPerQNT"));
        }

        public ColoredCoinsDividendPayment(long assetId, int height, long amountLQTPerQNT) {
            this.assetId = assetId;
            this.height = height;
            this.amountLQTPerQNT = amountLQTPerQNT;
        }
        ...
        void putMyBytes(ByteBuffer buffer) {
            ...
            buffer.putLong(amountLQTPerQNT);
        }
        ...
        void putMyJSON(JSONObject attachment) {
            ...
            attachment.put("amountLQTPerQNT", amountLQTPerQNT);
        }
        ...
        public long getAmountLQTPerQNT() {
            return amountLQTPerQNT;
        }
    ...
    final class DigitalGoodsListing extends AbstractAttachment {
        ...
        DigitalGoodsListing(ByteBuffer buffer, byte transactionVersion) throws LrdException.NotValidException {
            super(buffer, transactionVersion);
        ...
        public DigitalGoodsListing(String name, String description, String tags, int quantity, long priceLQT) {
            this.name = name;
            this.description = description;
            this.tags = tags;
        ...
        public long getPriceLQT() { return priceLQT; }
    ...
    final class DigitalGoodsPriceChange extends AbstractAttachment {
        ...
        public DigitalGoodsPriceChange(long goodsId, long priceLQT) {
            this.goodsId = goodsId;
            this.priceLQT = priceLQT;
        }
    ...
    final class DigitalGoodsPurchase extends AbstractAttachment {
        ...
        public DigitalGoodsPurchase(long goodsId, int quantity, long priceLQT, int deliveryDeadlineTimestamp) {
            this.goodsId = goodsId;
            this.quantity = quantity;
            this.priceLQT = priceLQT;
    ...
    class DigitalGoodsDelivery extends AbstractAttachment {
        ...
        private final long discountLQT;
        private final boolean goodsIsText;

        DigitalGoodsDelivery(ByteBuffer buffer, byte transactionVersion) throws LrdException.NotValidException {
            super(buffer, transactionVersion);
            ...
            this.discountLQT = buffer.getLong();
        }
        ...
        DigitalGoodsDelivery(JSONObject attachmentData) {
            ...
            this.discountLQT = Convert.parseLong(attachmentData.get("discountLQT"));
            this.goodsIsText = Boolean.TRUE.equals(attachmentData.get("goodsIsText"));
        }

        public DigitalGoodsDelivery(long purchaseId, EncryptedData goods, boolean goodsIsText, long discountLQT) {
            this.purchaseId = purchaseId;
            this.goods = goods;
            this.discountLQT = discountLQT;
        ...
        void putMyJSON(JSONObject attachment) {
            ...
            attachment.put("discountLQT", discountLQT);
        ...
        public final long getDiscountLQT() {
            return discountLQT;
        }
    ...
    final class UnencryptedDigitalGoodsDelivery extends DigitalGoodsDelivery implements Encryptable {
        ...
        public UnencryptedDigitalGoodsDelivery(long purchaseId, byte[] goodsToEncrypt, boolean goodsIsText, long discountLQT, byte[] recipientPublicKey) {
            super(purchaseId, null, goodsIsText, discountLQT);
        ...
        void putMyBytes(ByteBuffer buffer) {
            if (getGoods() == null) {
                throw new LrdException.NotYetEncryptedException("Goods not yet encrypted");
            }
        ...
        void putMyJSON(JSONObject attachment) {
            if (getGoods() == null) {
                ...
                attachment.put("discountLQT", getDiscountLQT());
                attachment.put("goodsIsText", goodsIsText());
            } else {
    ...
    final class DigitalGoodsRefund extends AbstractAttachment {
        ...
        private final long purchaseId;
        private final long refundLQT;

        DigitalGoodsRefund(ByteBuffer buffer, byte transactionVersion) {
            super(buffer, transactionVersion);
            this.purchaseId = buffer.getLong();
            this.refundLQT = buffer.getLong();
        }

        DigitalGoodsRefund(JSONObject attachmentData) {
            super(attachmentData);
            this.purchaseId = Convert.parseUnsignedLong((String)attachmentData.get("purchase"));
            this.refundLQT = Convert.parseLong(attachmentData.get("refundLQT"));
        }

        public DigitalGoodsRefund(long purchaseId, long refundLQT) {
            this.purchaseId = purchaseId;
            this.refundLQT = refundLQT;
        }
        ...
        void putMyBytes(ByteBuffer buffer) {
            buffer.putLong(purchaseId);
            buffer.putLong(refundLQT);
        }

        @Override
        void putMyJSON(JSONObject attachment) {
            attachment.put("purchase", Long.toUnsignedString(purchaseId));
            attachment.put("refundLQT", refundLQT);
        }
        ...
        public long getRefundLQT() { return refundLQT; }
    ...
    final class MonetarySystemCurrencyIssuance extends AbstractAttachment {
        ...
        private final long minReservePerUnitLQT;
        ...
        MonetarySystemCurrencyIssuance(ByteBuffer buffer, byte transactionVersion) throws LrdException.NotValidException {
            super(buffer, transactionVersion);
            ...
            this.minReservePerUnitLQT = buffer.getLong();
        ...
        MonetarySystemCurrencyIssuance(JSONObject attachmentData) {
            ...
            this.minReservePerUnitLQT = Convert.parseLong(attachmentData.get("minReservePerUnitLQT"));
        ...
        public MonetarySystemCurrencyIssuance(String name, String code, String description, byte type, long initialSupply, long reserveSupply,
                                              long maxSupply, int issuanceHeight, long minReservePerUnitLQT, int minDifficulty, int maxDifficulty,
            ...
            this.minReservePerUnitLQT = minReservePerUnitLQT;
        ...
        void putMyBytes(ByteBuffer buffer) {
            ...
            buffer.putLong(minReservePerUnitLQT);
        ...
        void putMyJSON(JSONObject attachment) {
            ...
            attachment.put("minReservePerUnitLQT", minReservePerUnitLQT);
        ...
        public long getMinReservePerUnitLQT() {
            return minReservePerUnitLQT;
        }
    ...
    final class MonetarySystemReserveIncrease extends AbstractAttachment implements MonetarySystemAttachment {
        ...
        private final long amountPerUnitLQT;

        MonetarySystemReserveIncrease(ByteBuffer buffer, byte transactionVersion) {
            super(buffer, transactionVersion);
            this.currencyId = buffer.getLong();
            this.amountPerUnitLQT = buffer.getLong();
        }

        MonetarySystemReserveIncrease(JSONObject attachmentData) {
            super(attachmentData);
            this.currencyId = Convert.parseUnsignedLong((String)attachmentData.get("currency"));
            this.amountPerUnitLQT = Convert.parseLong(attachmentData.get("amountPerUnitLQT"));
        }

        public MonetarySystemReserveIncrease(long currencyId, long amountPerUnitLQT) {
            this.currencyId = currencyId;
            this.amountPerUnitLQT = amountPerUnitLQT;
        }
        ...
        void putMyBytes(ByteBuffer buffer) {
            ...
            buffer.putLong(amountPerUnitLQT);
        }

        @Override
        void putMyJSON(JSONObject attachment) {
            attachment.put("currency", Long.toUnsignedString(currencyId));
            attachment.put("amountPerUnitLQT", amountPerUnitLQT);
        }
        ...
        public long getAmountPerUnitLQT() {
            return amountPerUnitLQT;
        }
    ...
    final class MonetarySystemPublishExchangeOffer extends AbstractAttachment implements MonetarySystemAttachment {
        ...
        private final long currencyId;
        private final long buyRateLQT;
        private final long sellRateLQT;
        ...
        MonetarySystemPublishExchangeOffer(ByteBuffer buffer, byte transactionVersion) {
            super(buffer, transactionVersion);
            this.currencyId = buffer.getLong();
            this.buyRateLQT = buffer.getLong();
            this.sellRateLQT = buffer.getLong();
        ...
        MonetarySystemPublishExchangeOffer(JSONObject attachmentData) {
            super(attachmentData);
            this.currencyId = Convert.parseUnsignedLong((String)attachmentData.get("currency"));
            this.buyRateLQT = Convert.parseLong(attachmentData.get("buyRateLQT"));
            this.sellRateLQT = Convert.parseLong(attachmentData.get("sellRateLQT"));
        ...
        public MonetarySystemPublishExchangeOffer(long currencyId, long buyRateLQT, long sellRateLQT, long totalBuyLimit,
                                                  long totalSellLimit, long initialBuySupply, long initialSellSupply, int expirationHeight) {
            this.currencyId = currencyId;
            this.buyRateLQT = buyRateLQT;
            this.sellRateLQT = sellRateLQT;
        ...
        void putMyBytes(ByteBuffer buffer) {
            buffer.putLong(currencyId);
            buffer.putLong(buyRateLQT);
            buffer.putLong(sellRateLQT);
        ...
        void putMyJSON(JSONObject attachment) {
            attachment.put("currency", Long.toUnsignedString(currencyId));
            attachment.put("buyRateLQT", buyRateLQT);
            attachment.put("sellRateLQT", sellRateLQT);
        ...
        public long getBuyRateLQT() {
            return buyRateLQT;
        }

        public long getSellRateLQT() {
            return sellRateLQT;
        }
    ...
    abstract class MonetarySystemExchange extends AbstractAttachment implements MonetarySystemAttachment {
        ...
        private MonetarySystemExchange(JSONObject attachmentData) {
            super(attachmentData);
            this.currencyId = Convert.parseUnsignedLong((String)attachmentData.get("currency"));
            this.rateLQT = Convert.parseLong(attachmentData.get("rateLQT"));
            this.units = Convert.parseLong(attachmentData.get("units"));
        }

        private MonetarySystemExchange(long currencyId, long rateLQT, long units) {
            this.currencyId = currencyId;
        ...
        void putMyJSON(JSONObject attachment) {
            attachment.put("currency", Long.toUnsignedString(currencyId));
            attachment.put("rateLQT", rateLQT);
            attachment.put("units", units);
        }
    ...
    final class MonetarySystemExchangeBuy extends MonetarySystemExchange {
        ...
        public MonetarySystemExchangeBuy(long currencyId, long rateLQT, long units) {
            super(currencyId, rateLQT, units);
        }
    ...
    final class MonetarySystemExchangeSell extends MonetarySystemExchange {
        ...
        public MonetarySystemExchangeSell(long currencyId, long rateLQT, long units) {
            super(currencyId, rateLQT, units);
        }
    ...
    final class TaggedDataUpload extends TaggedDataAttachment {
        ...
        public TaggedDataUpload(String name, String description, String tags, String type, String channel, boolean isText,
                                String filename, byte[] data) throws LrdException.NotValidException {
            ...
            if (isText && !Arrays.equals(data, Convert.toBytes(Convert.toString(data)))) {
                throw new LrdException.NotValidException("Data is not UTF-8 text");
            }
        }
