...
public final class Trade {
    ...
    private Trade(long assetId, Order.Ask askOrder, Order.Bid bidOrder) {
        Block block = Lrd.getBlockchain().getLastBlock();
        ...
        this.priceLQT = isBuy ? askOrder.getPriceLQT() : bidOrder.getPriceLQT();
    }
    ...
    public String toString() {
        return "Trade asset: " + Long.toUnsignedString(assetId) + " ask: " + Long.toUnsignedString(askOrderId)
                + " bid: " + Long.toUnsignedString(bidOrderId) + " price: " + priceLQT + " quantity: " + quantityQNT + " height: " + height;
    }
