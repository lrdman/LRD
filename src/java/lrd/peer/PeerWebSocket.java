...
public class PeerWebSocket {
    ...
    private static final boolean isGzipEnabled = Lrd.getBooleanProperty("lrd.enablePeerServerGZIPFilter");
    ...
    public boolean startClient(URI uri) throws IOException {
        ...
        // since the LRS server will issue multiple concurrent requests to the same peer.
