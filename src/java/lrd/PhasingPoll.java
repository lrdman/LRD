...
public final class PhasingPoll extends AbstractPoll {
    ...
    public static int getPhasedCount() {
        return phasingPollTable.getCount(new DbClause.IntClause("finish_height", DbClause.Op.GT, Lrd.getBlockchain().getHeight()));
    }
    ...
    public long getResult() {
        ...
        int height = Math.min(this.finishHeight, Lrd.getBlockchain().getHeight());
