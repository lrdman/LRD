...
public final class Convert {
    ...
    public static String rsAccount(long accountId) {
        return "LRD-" + Crypto.rsEncode(accountId);
    }
    ...
    public static String readString(ByteBuffer buffer, int numBytes, int maxLength) throws LrdException.NotValidException {
        if (numBytes > 3 * maxLength) {
            throw new LrdException.NotValidException("Max parameter length exceeded");
        }
    ...
    public static long parseLRD(String lrd) {
        return parseStringFraction(lrd, 8, Constants.MAX_BALANCE_LRD);
    }
