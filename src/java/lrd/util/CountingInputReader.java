...
import lrd.LrdException.LrdIOException;
...
public class CountingInputReader extends FilterReader {
     ...
     * @throws  LrdIOException      Maximum count exceeded
     */
    private void incCount(long c) throws LrdIOException {
        count += c;
        if (count > limit)
            throw new LrdIOException("Maximum size exceeded: " + count);
    }
}
