...
import static lrd.http.JSONResponses.INCORRECT_ALIAS_NOTFORSALE;
...
public final class BuyAlias extends CreateTransaction {
    ...
    private BuyAlias() {
        super(new APITag[] {APITag.ALIASES, APITag.CREATE_TRANSACTION}, "alias", "aliasName", "amountLQT");
    }
    ...
    JSONStreamAware processRequest(HttpServletRequest req) throws LrdException {
        ...
        long amountLQT = ParameterParser.getAmountLQT(req);
        ...
        return createTransaction(req, buyer, sellerId, amountLQT, attachment);
    }
}
