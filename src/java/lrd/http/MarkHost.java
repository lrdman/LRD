...
import static lrd.http.JSONResponses.INCORRECT_DATE;
import static lrd.http.JSONResponses.INCORRECT_HOST;
import static lrd.http.JSONResponses.INCORRECT_WEIGHT;
import static lrd.http.JSONResponses.MISSING_DATE;
import static lrd.http.JSONResponses.MISSING_HOST;
import static lrd.http.JSONResponses.MISSING_SECRET_PHRASE;
import static lrd.http.JSONResponses.MISSING_WEIGHT;
...
public final class MarkHost extends APIServlet.APIRequestHandler {
    ...
    JSONStreamAware processRequest(HttpServletRequest req) {
        ...
        try {
            ...
            if (weight <= 0 || weight > Constants.MAX_BALANCE_LRD) {
