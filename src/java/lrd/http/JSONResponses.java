...
public final class JSONResponses {
    ...
    public static final JSONStreamAware INCORRECT_PURCHASE_PRICE = incorrect("priceLQT", "(purchase price doesn't match goods price)");
    ...
    public static final JSONStreamAware INCORRECT_DGS_DISCOUNT = incorrect("discountLQT");
    public static final JSONStreamAware INCORRECT_DGS_REFUND = incorrect("refundLQT");
    ...
    public static final JSONStreamAware INCORRECT_ADMIN_PASSWORD = incorrect("adminPassword", "(the specified password does not match lrd.adminPassword)");
    ...
    static {
        JSONObject response = new JSONObject();
        response.put("errorCode", 8);
        response.put("errorDescription", "Administrator's password is not configured. Please set lrd.adminPassword");
    ...
    static {
        JSONObject response = new JSONObject();
        response.put("errorCode", 8);
        response.put("errorDescription", "Poll results no longer available, set lrd.processPolls=true and rescan");
