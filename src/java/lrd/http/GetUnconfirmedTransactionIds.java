...
import static lrd.http.JSONResponses.INCORRECT_ACCOUNT;
...
public final class GetUnconfirmedTransactionIds extends APIServlet.APIRequestHandler {
    ...
    JSONStreamAware processRequest(HttpServletRequest req) {
        ...
        try (DbIterator<? extends Transaction> transactionsIterator = Lrd.getTransactionProcessor().getAllUnconfirmedTransactions()) {
