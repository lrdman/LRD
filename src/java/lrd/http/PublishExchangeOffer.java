...
/**
 * Publish exchange offer for {@link lrd.CurrencyType#EXCHANGEABLE} currency
 * <p>
 * Parameters
 * <ul>
 * <li>currency - currency id of an active currency
 * <li>buyRateLQT - LRD amount for buying a currency unit specified in LQT
 * <li>sellRateLQT - LRD amount for selling a currency unit specified in LQT
 ...
 * Typically the buyRateLQT specified would be less than the sellRateLQT thus allowing the publisher to make profit
 *
 * <p>
...
public final class PublishExchangeOffer extends CreateTransaction {
    ...
    private PublishExchangeOffer() {
        super(new APITag[] {APITag.MS, APITag.CREATE_TRANSACTION}, "currency", "buyRateLQT", "sellRateLQT",
    ...
    JSONStreamAware processRequest(HttpServletRequest req) throws LrdException {
        ...
        long buyRateLQT = ParameterParser.getLong(req, "buyRateLQT", 0, Long.MAX_VALUE, true);
        long sellRateLQT= ParameterParser.getLong(req, "sellRateLQT", 0, Long.MAX_VALUE, true);
        ...
        Attachment attachment = new Attachment.MonetarySystemPublishExchangeOffer(currency.getId(), buyRateLQT, sellRateLQT,
                totalBuyLimit, totalSellLimit, initialBuySupply, initialSellSupply, expirationHeight);
