...
import static lrd.http.JSONResponses.*;
...
final class ParameterParser {
    ...
    static long getAmountLQT(HttpServletRequest req) throws ParameterException {
        return getLong(req, "amountLQT", 1L, Constants.MAX_BALANCE_LQT, true);
    }

    static long getFeeLQT(HttpServletRequest req) throws ParameterException {
        return getLong(req, "feeLQT", 0L, Constants.MAX_BALANCE_LQT, true);
    }

    static long getPriceLQT(HttpServletRequest req) throws ParameterException {
        return getLong(req, "priceLQT", 1L, Constants.MAX_BALANCE_LQT, true);
    }
    ...
    static long getAmountLQTPerQNT(HttpServletRequest req) throws ParameterException {
        return getLong(req, "amountLQTPerQNT", 1L, Constants.MAX_BALANCE_LQT, true);
    }
    ...
    static int getNumberOfConfirmations(HttpServletRequest req) throws ParameterException {
        return getInt(req, "numberOfConfirmations", 0, Lrd.getBlockchain().getHeight(), false);
    }
    ...
    static Transaction.Builder parseTransaction(String transactionJSON, String transactionBytes, String prunableAttachmentJSON) throws ParameterException {
        ...
        if (transactionJSON != null) {
            try {
                ...
                return Lrd.newTransactionBuilder(json);
            } catch (LrdException.ValidationException | RuntimeException | ParseException e) {
            ...
            try {
                ...
                return Lrd.newTransactionBuilder(bytes, prunableAttachments);
            } catch (LrdException.ValidationException|RuntimeException | ParseException e) {
                Logger.logDebugMessage(e.getMessage(), e);
                JSONObject response = new JSONObject();
    ...
    static Attachment.TaggedDataUpload getTaggedData(HttpServletRequest req) throws ParameterException, LrdException.NotValidException {
