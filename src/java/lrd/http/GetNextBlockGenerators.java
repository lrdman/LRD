...
public final class GetNextBlockGenerators extends APIServlet.APIRequestHandler {
    ...
    JSONStreamAware processRequest(HttpServletRequest req) {
        ...
        if (block == null) {
            curBlock = Lrd.getBlockchain().getLastBlock();
        } else {
            try {
                curBlock = Lrd.getBlockchain().getBlock(Convert.parseUnsignedLong(block));
                if (curBlock == null) {
        ...
        */
        ...
        Block curBlock = Lrd.getBlockchain().getLastBlock();
        ...
        while (iterator.hasNext() && hubs.size() < limit) {
            ...
            hub.put("minFeePerByteLQT", hit.hub.getMinFeePerByteLQT());
