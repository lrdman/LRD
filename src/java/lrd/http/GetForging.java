...
import static lrd.http.JSONResponses.NOT_FORGING;
import static lrd.http.JSONResponses.UNKNOWN_ACCOUNT;
...
public final class GetForging extends APIServlet.APIRequestHandler {
    ...
    JSONStreamAware processRequest(HttpServletRequest req) throws ParameterException {
        ...
        int elapsedTime = Lrd.getEpochTime() - Lrd.getBlockchain().getLastBlock().getTimestamp();
