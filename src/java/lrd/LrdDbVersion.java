...
import lrd.db.DbVersion;
import lrd.util.Logger;

class LrdDbVersion extends DbVersion {
        ...
        switch (nextUpdate) {
            ...
            case 138:
                apply("CREATE TABLE IF NOT EXISTS currency (db_id IDENTITY, id BIGINT NOT NULL, account_id BIGINT NOT NULL, "
                        ...
                        + "min_reserve_per_unit_lqt BIGINT NOT NULL, min_difficulty TINYINT NOT NULL, "
            ...
            case 193:
                apply("CREATE TABLE IF NOT EXISTS currency_supply (db_id IDENTITY, id BIGINT NOT NULL, "
                        + "current_supply BIGINT NOT NULL, current_reserve_per_unit_lqt BIGINT NOT NULL, height INT NOT NULL, "
                        + "latest BOOLEAN NOT NULL DEFAULT TRUE)");
            case 194:
            ...
            case 197:
                apply("ALTER TABLE currency DROP COLUMN IF EXISTS current_reserve_per_unit_lqt");
            case 198:
                apply(null);
            case 199:
                apply(null);
