...
public class DesktopSystemTray {
    ...
    void createAndShowGUI() {
        ...
        imageIcon = new ImageIcon("html/img/lrd-icon-32x32.png", "tray icon");
    ...
    private void displayStatus() {
        ...
        addDataRow(statusPanel, "Application", Lrd.APPLICATION);
        addDataRow(statusPanel, "Version", Lrd.VERSION);
        ...
        addDataRow(statusPanel, "User folder", String.valueOf(Paths.get(Lrd.getUserHomeDir()).toAbsolutePath()));
        ...
        if (lastBlock != null) {
            ...
            addDataRow(statusPanel, "Seconds passed", String.valueOf(Lrd.getEpochTime() - lastBlock.getTimestamp()));
        ...
        addDataRow(statusPanel, "Process id", Lrd.getProcessId());
        addEmptyRow(statusPanel);
        ...
        if (statusDialog == null || !statusDialog.isVisible()) {
            ...
            statusDialog = pane.createDialog(wrapper, "LRD Server Status");
