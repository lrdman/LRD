...
import lrd.Lrd;
import lrd.env.service.LrdService_ServiceManagement;
...
public class ManifestGenerator {
    ...
    public static void main(String[] args) {
        ...
        manifestGenerator.generate("./resource/lrd.manifest.mf", Lrd.class.getCanonicalName(), "./lib");
        String serviceClassName = LrdService_ServiceManagement.class.getCanonicalName();
        serviceClassName = serviceClassName.substring(0, serviceClassName.length() - "_ServiceManagement".length());
        manifestGenerator.generate("./resource/lrdservice.manifest.mf", serviceClassName, "./lib");
    }
