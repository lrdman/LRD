...
public interface Transaction {
    ...
    interface Builder {
        ...
        Transaction build() throws LrdException.NotValidException;

        Transaction build(String secretPhrase) throws LrdException.NotValidException;
    ...
    void validate() throws LrdException.ValidationException;
