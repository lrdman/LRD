...
public abstract class LrdException extends Exception {

    protected LrdException() {
        super();
    }

    protected LrdException(String message) {
        super(message);
    }

    protected LrdException(String message, Throwable cause) {
        super(message, cause);
    }

    protected LrdException(Throwable cause) {
        super(cause);
    }

    public static abstract class ValidationException extends LrdException {
    ...
    public static final class LrdIOException extends IOException {

        public LrdIOException(String message) {
            super(message);
        }

        public LrdIOException(String message, Throwable cause) {
            super(message, cause);
        }
