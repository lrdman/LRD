...
var LRS = (function(LRS, $, undefined) {
    ...
    LRS.loadLockscreenHTML = function(path, options) {
    	jQuery.ajaxSetup({ async: false });
    	$.get(path, '', function (data) { $("body").prepend(data); });
    	jQuery.ajaxSetup({ async: true });
    }

    LRS.loadHeaderHTML = function(path, options) {
    	jQuery.ajaxSetup({ async: false });
    	$.get(path, '', function (data) { $("body").prepend(data); });
    	jQuery.ajaxSetup({ async: true });
    }

    LRS.loadSidebarHTML = function(path, options) {
    	jQuery.ajaxSetup({ async: false });
    	$.get(path, '', function (data) { $("#sidebar").append(data); });
    	jQuery.ajaxSetup({ async: true });
    }

    LRS.loadSidebarContextHTML = function(path, options) {
    	jQuery.ajaxSetup({ async: false });
    	$.get(path, '', function (data) { $("body").append(data); });
    	jQuery.ajaxSetup({ async: true });
    }

    LRS.loadPageHTML = function(path, options) {
    	jQuery.ajaxSetup({ async: false });
        LRS.asyncLoadPageHTML(path);
    	jQuery.ajaxSetup({ async: true });
    }

    LRS.asyncLoadPageHTML = function(path) {
    	$.get(path, '', function (data) { $("#content").append(data); });
    }

    LRS.loadModalHTML = function(path, options) {
    	jQuery.ajaxSetup({ async: false });
    	$.get(path, '', function (data) { $("body").append(data); });
    	jQuery.ajaxSetup({ async: true });
    }

    LRS.loadPageHTMLTemplates = function(options) {
    ...
    LRS.loadModalHTMLTemplates = function(options) {
        jQuery.ajaxSetup({ async: false });
    ...
    LRS.preloadModalUIElements = function(options) {
        jQuery.ajaxSetup({ async: false });
    ...
    LRS.initModalUIElement = function($modal, selector, elementName, context) {
    ...
    LRS.addSimpleSidebarMenuItem = function(options) {
    ...
    LRS.addTreeviewSidebarMenuItem = function(options) {
    ...
    LRS.appendMenuItemToTSMenuItem = function(itemId, options) {
    ...
    LRS.appendSubHeaderToTSMenuItem = function(itemId, options) {
