/*
    LRD address class, extended version (with error guessing).

    Version: 1.0, license: Public Domain, coder: LrdChg (admin@lrdchg.com).
*/
...
function LrdAddress() {
	...
	this.set = function(adr, allow_accounts) {
		...
		if (adr.indexOf('LRD-') == 0) adr = adr.substr(4);
